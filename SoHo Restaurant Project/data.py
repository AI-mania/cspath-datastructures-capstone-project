...
types = ['german', 'japanese', 'vegetarian', 'french', 'african', 'american',
         'barbecue', 'czech', 'chinese', 'thai', 'mexican', 'indian', 'cafe',
         'pizza', 'italian']

restaurant_data = [['german', "Esther's German Saloon", '3', '3',
                    '22 Teutonic Ave.'], ['japanese', 'Robatayaki Hachi', '4', '5', '8 Hawthorne Ln.'],
                   ...
                   ['indian', 'Naan Sequitur', '5', '4', '"Unit 12'], ['japanese', 'Sakura', '3', '2', '"Unit 18'], ['chinese', 'Shandong Lu', '4', '3', '335 University'], ['indian', 'Curry Galore', '3', '2', '56 Park Ave'], ['cafe', 'North by Northwest', '1', '4', '201 University'], ['cafe', 'Full of Beans', '3', '5', '498 College Ave.'], ['cafe', "Tropical Jeeve's Cafe", '2', '4', '550 Milliways Ave']
